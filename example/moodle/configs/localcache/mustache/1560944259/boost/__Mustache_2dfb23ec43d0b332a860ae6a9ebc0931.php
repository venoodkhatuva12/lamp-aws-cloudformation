...
class __Mustache_2dfb23ec43d0b332a860ae6a9ebc0931 extends Mustache_Template
{
...
';
        ...
        $blocksContext['title'] = array($this, 'blockEa4a9f0731767159e863e1db7e72336d');
        $blocksContext['extratitleclasses'] = array($this, 'block38999efb548e1543b72f05033be446fd');
        $blocksContext['startday'] = array($this, 'blockEa230cf4d288c3881a266d7b3094d7c5');
        $blocksContext['endday'] = array($this, 'blockE13f09ec51e6aa10c3789885dab1c67f');
        ...
        $blocksContext['title'] = array($this, 'block06df5a9d0e1d780d3c87f4275a8bcb47');
        $blocksContext['extratitleclasses'] = array($this, 'blockD41d8cd98f00b204e9800998ecf8427e');
        $blocksContext['startday'] = array($this, 'blockE13f09ec51e6aa10c3789885dab1c67f');
        $blocksContext['endday'] = array($this, 'blockE052079a625ca42b568ba24af19cc7eb');
        ...
        $blocksContext['title'] = array($this, 'block57cf602548cea5271a14e50954788621');
        $blocksContext['extratitleclasses'] = array($this, 'blockD41d8cd98f00b204e9800998ecf8427e');
        $blocksContext['startday'] = array($this, 'blockE052079a625ca42b568ba24af19cc7eb');
        $blocksContext['endday'] = array($this, 'blockCea7eb43b2813988eae06d16e48e891d');
        ...
        $blocksContext['title'] = array($this, 'block0f83c405c18f64e68ad4fe7253cc9942');
        $blocksContext['extratitleclasses'] = array($this, 'blockD41d8cd98f00b204e9800998ecf8427e');
        $blocksContext['startday'] = array($this, 'blockCea7eb43b2813988eae06d16e48e891d');
        $blocksContext['endday'] = array($this, 'block28496b40d26042aab6f3e0806a415f72');
        ...
        $blocksContext['title'] = array($this, 'blockC0793e31d2c3d60c77c996977e673ed1');
        $blocksContext['extratitleclasses'] = array($this, 'blockD41d8cd98f00b204e9800998ecf8427e');
        $blocksContext['startday'] = array($this, 'block28496b40d26042aab6f3e0806a415f72');
        $blocksContext['endday'] = array($this, 'blockD41d8cd98f00b204e9800998ecf8427e');
